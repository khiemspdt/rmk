...
async fn main(_spawner: Spawner) {
    ...
    // --- MuxMatrix Example for STM32G4/Embassy ---
    {
        ...
        const MUX_COUNT: usize = 4; // Number of MUX chips
        ...
        let mut s0 = Output::new(p.PB12, embassy_stm32::gpio::Level::Low, embassy_stm32::gpio::Speed::Low);
        let mut s1 = Output::new(p.PB13, embassy_stm32::gpio::Level::Low, embassy_stm32::gpio::Speed::Low);
        let mut s2 = Output::new(p.PB14, embassy_stm32::gpio::Level::Low, embassy_stm32::gpio::Speed::Low);
        let mut s3 = Output::new(p.PB15, embassy_stm32::gpio::Level::Low, embassy_stm32::gpio::Speed::Low);
        ...
        let mut input_pins = [adc_s0, adc_s1, adc_s2, adc_s3]; // [AnyAdcChannel<ADC2>; MUX_COUNT]
